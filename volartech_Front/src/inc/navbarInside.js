		 				...
		 				<div className="content-select-service" layout="row" layout-align="space-around center">
			 				<a href="/quienes" flex="" className="padding-quarter">
				 				<div className="contenedor-textos-navb-inside">
				 					<p className="text-navbar-volartech-inside" style={{fontWeight: this.props.current === 0 ? 800 : 400}}>Quienes Somos</p>
				 				</div>
			 				</a>
			 				<a href="/produccion" flex="" className="padding-quarter">
			 				<div className="contenedor-textos-navb-inside">
			 					<p className="text-navbar-volartech-inside" style={{fontWeight: this.props.current === 1 ? 800 : 400}}>Produccion</p>
			 				</div>
			 				</a>
			 				<a href="/construccion" flex="" className="padding-quarter">
				 				<div className="contenedor-textos-navb-inside">
				 					<p className="text-navbar-volartech-inside" style={{fontWeight: this.props.current === 2 ? 800 : 400}}>Construccion</p>
				 				</div>
			 				</a>
			 				<a href="/ingenieria" flex="" className="padding-quarter">
				 				<div className="contenedor-textos-navb-inside">
				 					<p className="text-navbar-volartech-inside" style={{fontWeight: this.props.current === 3 ? 800 : 400}}>Ingenieria</p>
				 				</div>
			 				</a>
