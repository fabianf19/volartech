			...
			<div className="background-produccion">
	 			...
	 			<div className="third-fond">
	 				<div>
	 					<div className="content-pre-produccion">
	 						<p className="p-p-p-aproduccion">Pre Producción</p>
	 						<p className="text-p-p-p-aproduccion">Es la etapa que comprende desde la concepción de la idea hasta el primer día de grabación.</p>
	 			...
	 			<div className="fourth-fond">
	 				<div>
	 					<div className="content-produccion">
	 						<p className="p-p-p-aproduccion">Producción</p>
	 						<p className="text-p-p-p-aproduccion">Para esta etapa contamos con profesionales en registro de video y equipos de alta gama para rodajes en full HD o 4K. </p>
	 						<div className="div-produccion-line"></div>
	 					</div>
	 			...
	 			<div className="fifth-fond">
	 				<div>
	 					<div className="content-post-produccion">
	 						<p className="p-p-p-aproduccion">Post Producción</p>
	 						<p className="text-p-p-p-aproduccion">Nos aseguramos que después de haber hecho el registro de video en la etapa de edición sus videos queden emocionales y que hablen por si solos.</p>
	 						<div className="div-produccion-line"></div>
	 					</div>
	 			...
	 			<div className="sixth-fond">
	 				<div>
	 					<div className="content-animacion">
	 						<p className="p-p-p-aproduccion">Animación</p>
	 						<p className="text-p-p-p-aproduccion">Nuestro objetivo es explicar tus ideas mostrando contenidos de manera atractiva y dinámica.</p>
	 						<div className="div-produccion-line"></div>
	 					</div>
	 			...
	 			<div className="ultimo-fondo-produccion">
	 				<div className="content-text-nuestrotrabajo">
	 					<p className="text-nuestro-trabajo">Algo de nuestro trabajo</p>
	 				</div>
	 				...
	 				<div className="contenedor-interes-boton-contacto-prod">
	 					<div className="content-info-interes-prod">
	 						<p className="text-te-interesa-prod">Te interesa?</p>
	 						<p className="text-text-interes-prod">Si te interesa alguno de nuestros servicios no dudes en ponerte en contacto.</p>
	 					</div>
	 					<div>
	 						...
	 						<div className="content-mail-call-prod">
	 							<a href="mailto:contacto@volartech.com">
		 							<div className="boton-mail-prod">
		 								...
		 								<p className="text-mail-mail-prod">contacto@volartech.com.co</p>
		 							</div>
	 							</a>
